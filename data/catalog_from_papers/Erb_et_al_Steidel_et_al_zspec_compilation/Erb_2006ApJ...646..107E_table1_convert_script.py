...
out_table.write('Erb_2006ApJ...646..107E_table1_photometry_converted.txt', format='ascii.fixed_width', delimiter='  ', bookend=True, overwrite=True)
with open('Erb_2006ApJ...646..107E_table1_photometry_converted.txt', 'r+') as fp:
    fp.seek(0)
    fp.write('#')
print('Output to "%s"'%('Erb_2006ApJ...646..107E_table1_photometry_converted.txt'))
