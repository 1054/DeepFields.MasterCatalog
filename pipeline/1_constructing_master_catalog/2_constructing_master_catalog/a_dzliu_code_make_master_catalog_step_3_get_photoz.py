...
# <TODO> User-input
Output_column_sel = []
Output_column_sel.append({'Catalog': 1, 'Column': 'ZPDF',           'ID': 'NUMBER', 'OutputName': 'Laigle_Z_MED'     }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'ZPDF_L68',       'ID': 'NUMBER', 'OutputName': 'Laigle_Z_L68'     }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'ZPDF_H68',       'ID': 'NUMBER', 'OutputName': 'Laigle_Z_H68'     }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'ZMINCHI2',       'ID': 'NUMBER', 'OutputName': 'Laigle_Z_BEST'    }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'ZP_2',           'ID': 'NUMBER', 'OutputName': 'Laigle_Z_SECOND'  }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'MASS_MED',       'ID': 'NUMBER', 'OutputName': 'Laigle_MASS_MED'  }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'MASS_MED_MIN68', 'ID': 'NUMBER', 'OutputName': 'Laigle_MASS_L68'  }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'MASS_MED_MAX68', 'ID': 'NUMBER', 'OutputName': 'Laigle_MASS_H68'  }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'MASS_BEST',      'ID': 'NUMBER', 'OutputName': 'Laigle_MASS_BEST' }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'SFR_MED',        'ID': 'NUMBER', 'OutputName': 'Laigle_SFR_MED'   }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'SFR_MED_MIN68',  'ID': 'NUMBER', 'OutputName': 'Laigle_SFR_L68'   }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'SFR_MED_MAX68',  'ID': 'NUMBER', 'OutputName': 'Laigle_SFR_H68'   }) # 'OutputName' must be unique here!
Output_column_sel.append({'Catalog': 1, 'Column': 'SFR_BEST',       'ID': 'NUMBER', 'OutputName': 'Laigle_SFR_BEST'  }) # 'OutputName' must be unique here!

Output_File = 'master_catalog_single_entry_with_photoz.txt'

Input_Cat = 'master_catalog_multi_entries.txt'
...
Output_data_var = []
# 
Output_header_fmt = '# %13s %15s %15s %15s %15s %15s'
# 
Output_data_fmt = '%15d %15.10f %15.10f %15d %15d %15d' # ID RA Dec Flag Dupl ID_Origin, and more in Output_column_sel. 
# 
...
for var in Output_column_sel:
    ...
    Output_header_fmt = Output_header_fmt + ' %15s'
    Output_data_fmt = Output_data_fmt + ' %15g'
...
for i in range(len(ID_1)):
    ...
    for var in Output_column_sel:
        if (globals()['Flag_%d'%(var['Catalog'])])[i] >= 0: 
            ...
            # 
            # append to the output data array #<TODO># datatype
